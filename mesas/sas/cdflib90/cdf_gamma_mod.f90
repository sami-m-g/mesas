MODULE cdf_gamma_mod
        ...
        ! ..
        ! .. Public Statements ..
              PUBLIC :: ccum_gamma, cdf_gamma, cum_gamma, inv_gamma, cum_gamma_pure
        ! ..
            CONTAINS
        ...
        !*********************************************************************
                PURE FUNCTION cum_gamma_pure(x,shape)
                USE biomath_mathlib_mod
        ! .. Function Return Value ..
                REAL (dpkind) :: cum_gamma_pure
        ! ..
        ! .. Scalar Arguments ..
                REAL (dpkind), INTENT (IN) :: shape, x
                REAL (dpkind) :: cum, ccum
        ! ..
                CALL gratio(shape,x,cum,ccum,0)

                cum_gamma_pure = cum
        
                RETURN
        
                END FUNCTION cum_gamma_pure
        !*********************************************************************
