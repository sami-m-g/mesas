...
%{
 %% regularize singular c1inv, because pinv(A,tol) does this and the default tol is better 
...
if prior.flag ==0    % use Gaussian prior
   ...
   covInv = pinv(covPriorInv+c1inv);  covInv_chol = chol(covInv);
